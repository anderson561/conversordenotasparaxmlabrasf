...
1. Leia o arquivo gerado pelo Analista de Requisitos (`.agent/specs/requirements-elicitation-template.md`).
2. Divida os requisitos em tarefas técnicas menores dentro do template `.agent/specs/scrum-sprint-spec-template.md`.
