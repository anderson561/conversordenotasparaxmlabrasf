---
description: Conduz o ciclo iterativo de refatoração extrema (XP), orquestrando TDD estrito e pair programming simulado.
---
...
2. Verifique se o executor seguiu a risca a especificação em `.claude/specs/xp-engineering-spec-template.md`.
