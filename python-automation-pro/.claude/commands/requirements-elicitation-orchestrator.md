---
description: Conduz a elicitação e o refinamento de requisitos de alta complexidade, da análise de contexto até a geração da spec técnica final.
---
...
1. Monte o documento final seguindo à risca a estrutura de `.claude/specs/requirements-elicitation-template.md`.
