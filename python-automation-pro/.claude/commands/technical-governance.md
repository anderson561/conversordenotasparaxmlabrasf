---
description: Conduz a governança técnica e a revisão arquitetural, avaliando impacto estrutural e contratos de API antes da implementação.
---
...
2. Registre grandes alterações estruturais usando o formato `.claude/specs/architecture-decision-log.md`.
