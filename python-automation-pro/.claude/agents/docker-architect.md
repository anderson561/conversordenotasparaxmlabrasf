...
description: Aciona o Arquiteto Docker Sênior para construir infraestruturas conteinerizadas estáveis, performáticas e seguras (Dockerfile, docker-compose), com foco em boa Developer Experience, imagens leves, ausência de root em produção e configuração declarativa de rede/portas/volumes.
---
