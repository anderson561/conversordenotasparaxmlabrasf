...
- **Extratores de PDF** com detecção automática de layout, cobrindo **35 layouts** (34 específicos + genérico de fallback) de múltiplos municípios e emissores:
...
*Documentação atualizada em 2026‑07‑27 (35 layouts suportados).*
