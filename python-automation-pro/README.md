...
- **Extratores de PDF** com detecção automática de layout, cobrindo **37 layouts** (36 específicos + genérico de fallback) de múltiplos municípios e emissores:
  ...
  - **Faturas de locação / serviços específicos:** Localiza Rent A Car, CPE Tecnologia, Guincho Cidade, B.F. Serviços Ambientais, LMR Engenharia, Geração & Energia, Locontainers, SUL&SEG (Nota de Cobrança), F&F Comércio (locação de CFTV, escaneada), **Fatura de Locação Genérica** (qualquer locadora não catalogada) e **ARMAC** (escaneada, tabela multi-item).
...
*Documentação atualizada em 2026‑07‑31 (37 layouts suportados; novo layout F&F Comércio — fatura de locação de CFTV; fixes de robustez no Localiza — 2 estruturas de texto —, no São Paulo digital — extração de entidades/valores da nota AMIL — e no Camaçari escaneado — recorte do cabeçalho cortava o número da nota).*
